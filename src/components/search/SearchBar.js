...
const SearchBar = ({callBackFun, searchKey}) => {
  ...
  <div className="flex rounded-md shadow-sm">
    <input type="text" value={searchKey} onChange={searchOnChangeHandler} id="hs-search-box-with-loading-4" name="hs-search-box-with-loading-4" className="py-3 px-4 block w-full border-gray-200 shadow-sm rounded-l-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Input search" />
